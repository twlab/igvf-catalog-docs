...
Proteins (technically gene products) are annotated by the Gene Ontology project GAF files; these are represented as edges between proteins and ontology (GO) terms.

## Disease Annotations

Disease-Gene edges are loaded in the IGVF Catalog from [Orphanet](https://www.orpha.net/) and Variant-Disease-Genes annotations are loaded from the [https://clinicalgenome.org/]() database.
