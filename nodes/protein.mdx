...
* [IGVF Mutpred2](https://data.igvf.org/multireport/?type=TabularFile&status!=deleted&workflows.name=Mutpred2+workflow&content_type=coding+variant+effects): predictions for single amino acid substitution variants across all human genes.
